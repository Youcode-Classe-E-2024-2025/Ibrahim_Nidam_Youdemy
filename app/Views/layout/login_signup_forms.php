...
<div id="signinModal" class="fixed top-0 left-0 w-screen h-screen overflow-hidden bg-gradient-to-tl from-rose-800 via-rose-400 to-white hidden items-center justify-center">
    <div class="relative w-full max-w-md">
        ...
        <form id="signinForm" method="post" class="space-y-4">
            <div class="relative">
                <input type="text" id="signin-username" name="signin-username" required onblur="checkInput(this)" class="w-full bg-transparent border-b-2 border-white px-0 py-1 text-white focus:outline-none focus:border-white focus:shadow-sm peer mb-2" />
                <label for="signin-username" class="absolute left-0 text-white transition-all peer-focus:-translate-y-5 peer-focus:text-sm peer-active:-translate-y-5 peer-active:text-sm">Username</label>
            </div>
            <div class="relative">
                <input type="password" id="signin-password" name="signin-password" required onblur="checkInput(this)" class="w-full bg-transparent border-b-2 border-white px-0 py-1 text-white focus:outline-none focus:border-white focus:shadow-sm peer mb-2" />
                <label for="signin-password" class="absolute left-0 text-white transition-all peer-focus:-translate-y-5 peer-focus:text-sm peer-active:-translate-y-5 peer-active:text-sm">Password</label>
            </div>
...
<div id="learnModal" class="fixed top-0 left-0 w-screen h-screen overflow-hidden bg-gradient-to-tl from-rose-800 via-rose-400 to-white hidden items-center justify-center">
    <div class="relative w-full max-w-md">
        ...
        <form id="learnForm" method="post" class="space-y-4">
            <div class="relative">
...
<div id="teachModal" class="fixed top-0 left-0 w-screen h-screen overflow-hidden bg-gradient-to-tl from-rose-800 via-rose-400 to-white hidden items-center justify-center">
    <div class="relative w-full max-w-md">
        ...
        <form id="teachForm" method="post" class="space-y-4">
            <div class="relative">
